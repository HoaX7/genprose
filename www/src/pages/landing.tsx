...
import { AlertMessage } from "components/Commons/Alerts";

const content = [
	{
		key: "section1",
		name: "Paste your YouTube link",
		description: "Seamlessly paste your YouTube links, select your desired persona and tone, " + 
	...
	},
	{
		...
		description: "Our innovative platform allows you to choose a persona and tone for your articles, " +
	...
	return (
		<div className="bg-site-gradient text-white">
			<div className="container p-10 mx-auto">
				<div
					className="md:mt-32 mt-10 grid grid-cols-3 gap-4"
				>
					<div className="col-span-3 md:col-span-2">
						...
						<Typography
							...
							className="mt-5 !font-18 md:!font-24"
						>
                            Effortlessly convert your audio files into captivating articles that
                            resonate with your target audience.
                            Say goodbye to tedious transcription and manual content creation.
                            Our advanced AI algorithms extract valuable transcripts and keywords,
                            transforming them into compelling written content that captures the essence of your message.
						</Typography>
						<Button
							variant="div"
							font={20}
					...
					<div className="col-span-3 md:col-span-1">
						<div className={clsx("bg-site shadow rounded-md text-black w-full",
					...
					{content.map(({ name, key, description, gif }, i) => (
						<section key={key} id={key} 
							...
							<div className="grid grid-cols-3 gap-4">
								<div className={clsx(i % 2 === 0 ? "md:col-span-2" : "md:col-span-1", "col-span-3")}>
									{i % 2 === 0 ? (
								...
								<div className={clsx(i % 2 === 0 ? "md:col-span-1" : "md:col-span-2", "col-span-3")}>
									{i % 2 === 0 ? (
										<img 
											alt={key}
											width={500}
			...
			<section
				className="bg-[#ecf3ff] text-black"
				id="footer"
			>
				{isExploding && <div className="flex justify-center">
				...
				<div className="container p-10 mx-auto">
                    ...
                    content creation. Sign up below to be the first to 
                    know when <strong className="text-indigo-600">Gen Prose</strong> officially launches.
                     Get ready to unlock a new world of convenience, creativity, and efficiency.
					</Typography>
					<div className="md:w-2/5 mt-5 p-2 flex border-4 rounded-xl">
						...
						<Button
							...
							onClick={() => {
								setIsExploding(true);
								AlertMessage({
									text: "You are all set to get early access. " +
